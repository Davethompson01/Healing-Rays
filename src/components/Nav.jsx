...
import { useNavigate } from "react-router-dom"; // Import if you're using react-router-dom

const Nav = ({ aboutUsRef }) => {
  const liTags = [
    { p: "Home", path: "/" },
    { p: "About", path: "about" },
    { p: "Photo Gallery", path: "/photogallery" },
  ...
  const handleScrollToSection = (event, ref) => {
