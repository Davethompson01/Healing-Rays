      ...
      <div className="bg-[#F0F0F0]">
        ...
        <div className="grid place-items-center gap-7 px-5 sm:grid-cols-2 ">
          {maps.map((element, index) => (
            <div
              key={index}
              className=" bg-red-500 h-[450px] overflow-hidden gap-5 rounded-xl px-3 grid place-items-center  py-5 h-"
            >
              <div className="px-3">
